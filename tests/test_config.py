...
class TestBuilder(TestCase):
    ...
    def test_generate_builder_headers_remote(self):
        mock_resp = BuilderHeaderPayload(
            ...
            KUEST_BUILDER_SIGNATURE="A_Q3AZVfyzcumj4FAptV5QuQNIaTWqKdbutAiUtPHZk=",
        ).to_dict()
        responses.add(
